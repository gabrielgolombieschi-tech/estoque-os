          ...
          {phase === "ready" && (
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={!canSubmit}
                className="w-full px-4 py-2 rounded-md bg-emerald-300 text-emerald-950 hover:bg-emerald-200 font-medium disabled:opacity-60 disabled:cursor-not-allowed"
              >
