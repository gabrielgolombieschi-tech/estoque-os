...
// Manual da equipe atras do login do ERP. O texto e os prints trazem cliente, OC, precos e
// chave de NF-e, entao nada fica em public/: a pagina busca o index.html e as imagens em
// /api/manuais/... com o Bearer da sessao e monta tudo aqui. Sem sessao, a API responde 401.

const MANUAL = "vender-peca-importada";
...
export default function ManualVenderPecaImportadaPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // Imagens: cada uma vem pela API com o token e vira um blob local.
  ...
  return (
    <main className="mx-auto max-w-[1000px] p-4 text-zinc-100">
      <div className="mb-3 flex flex-wrap items-center justify-between gap-2 text-sm">
        <div className="text-zinc-400">Faturamento › Manuais › Vender peça que nós importamos</div>
        <Link href="/faturamento" className="rounded border border-zinc-700 px-3 py-1.5 hover:bg-zinc-900">Voltar</Link>
      </div>
