...
import {
  ...
  normalizeHorasNumber,
  parseHHMM,
  type HhLancamentoViewRow,
} from "@/lib/hh/relatorioHhCalculos";
...
export default function RelatorioHHSection({
  ...
  // O gerador do PDF mora em lib/hh/relatorioHhPdf.ts porque o aplicativo baixa
  // o mesmo arquivo pela rota /api/os/[id]/relatorio-hh. Aqui so disparamos o
  // download com os bytes que ele devolve.
  async function baixarRelatorioPdf() {
    try {
      const bytes = await gerarRelatorioHhPdf(
        hhRows,
        osId,
        {
      ...
      link.href = url;
      link.download = nomeArquivoRelatorioHh(osId);
