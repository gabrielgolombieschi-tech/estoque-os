...
| 2/23 | autorizada (NFS-e 11 de homologação, material de 50%); **cancelada** no mesmo dia para refazer com o material real | — |
| 2/24 | autorizada (NFS-e 12 de homologação, material real R$ 565,28); **cancelada** para trocar o texto do material | — |
| 2/30 | **autorizada** (NFS-e 15 de homologação), chave 42091022213671448000189000000000001526094792440903 | discriminação "MATERIAL APLICADO: R$ 565,28 (0,76% de Material)" (migration `20260911240000`) |

**Produção (11/09/2026, 17:49):** o Gabriel liberou o perfil 07.02 para esta homologação pela tela de perfis e emitiu a nota real pela OS: **NFS-e nº 54, DPS 2/3, tpAmb 1**, chave 42091022213671448000189000000000005426092063037592, retorno pelo webhook, XML e DANFSe arquivados. O payload de produção é igual ao da 15, fora o nome do tomador, as informações complementares e a alíquota (não vai em produção; o ambiente nacional parametrizou `pAliqAplic 2.00` sozinho, como previsto). XML: `vCalcDR 565,28 · vBC 73.473,08 · vISSQN 1.469,46 · vTotalRet 9.551,50 · vLiq 64.486,86`, obra na BR 280, 6918. Efeitos: documento EMITIDA na OS 139, título a receber R$ 64.486,86 com parcela em 09/10/2026 e retenções ISS 1.469,46 + INSS 8.082,04, PIS/COFINS próprios 1,65%/7,60%, saldo da OS 13.461,64 (Documentações). Primeira NFS-e de obra real pelo ERP.

Valores da NFS-e 15 (iguais aos da 12): bruto 74.038,36 · material 565,28 (0,76% do serviço) · ISS 2% 1.469,46 retido · INSS 11% 8.082,04 · líquido 64.486,86 em 28 dias · obra RODOVIA BR 280, 6918, KM 50 BLOCO A, CAIXA D AGUA, CEP 89272-554. A NFS-e 11 tinha 50% de material (37.019,18; líquido 69.225,87). Após a homologação, a OS 139 fica com R$ 13.461,64 de saldo (Documentações).
