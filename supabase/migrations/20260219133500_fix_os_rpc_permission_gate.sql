-- Permite operacoes de OS via RPC para perfis com os.write,
-- mantendo compatibilidade com o permiso legado os_rpcs.execute.
...
begin
  ...
  if not (public.can('os_rpcs', 'execute') or public.can('os', 'write')) then
