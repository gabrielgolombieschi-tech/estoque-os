-- Refino da auditoria de entradas:
-- 1) saldo_ajustado corrige excesso de saldo para itens diretos OS sem compensacao completa
-- 2) situacao nao deve alertar por saldo positivo quando estoque_ideal = 0
