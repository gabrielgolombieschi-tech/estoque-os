...
-- "GABRIEL MENDES TESTE") passa de TECNICO para COORDENACAO na ELETRICA SEGAU,
-- para a proxima rodada de testes.
--
-- O papel de tenant ja e GESTOR desde 20260907003000, que e exatamente o que
-- os coordenadores de verdade tem (Clarice, Cleiton, Douglas, Everton, Lucas,
-- Mateus e Vagner), entao a conta fica identica a deles: GESTOR no tenant,
-- COORDENACAO na empresa e membership 'projetos'.
