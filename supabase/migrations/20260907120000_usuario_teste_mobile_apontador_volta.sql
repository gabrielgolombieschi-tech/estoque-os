...
-- "GABRIEL MENDES TESTE") volta de COORDENACAO para APONTADOR na ELETRICA
-- SEGAU, para testar o perfil na build 17.
--
-- O papel de tenant ja e GESTOR desde 20260907003000, que e o mesmo dos
-- apontadores de verdade (Samuel e Paulo Andre), entao desta vez a conta fica
-- identica a deles: GESTOR no tenant e APONTADOR na empresa. A projecao
-- (trg_sync_usuario_empresa_projection) cuida de tenant_memberships sozinha.
...
begin
  ...
  if v_papel_empresa is distinct from 'APONTADOR' or v_papel_tenant is distinct from 'GESTOR' then
