...
-- "GABRIEL MENDES TESTE") volta de APONTADOR para TECNICO na ELETRICA SEGAU,
-- para a rodada de testes do perfil tecnico.
--
-- O papel de tenant continua GESTOR (20260907003000), entao a conta nao ganha
-- nada por baixo do que a tela mostra.
...
begin
  ...
  if v_papel_empresa is distinct from 'TECNICO' or v_papel_tenant is distinct from 'GESTOR' then
