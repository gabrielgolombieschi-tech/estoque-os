-- A conferencia da OS grava a transportadora e os volumes, em vez de joga-los fora.
--
-- f.fn_os_nfe_conferir_homologacao recebia o transporte no p_operacao (a tela de faturar
-- a OS coleta transportadora, modalidade e volumes com peso) e gravava
-- "transportador_dados = null, volumes_dados = null", guardando so a modalidade. Sem
-- transportadora, montarPayloadNfe rebaixa a nota para modalidade 9: a NF-e saia SEM
-- FRETE mesmo com a transportadora preenchida na tela, e nada avisava.
--
-- Apareceu na OS 319 em 10/09/2026, que o Gabriel pediu para mandar por transportadora:
-- a homologacao 2/46 saiu com modalidade 9, sem transportadora e sem volume, enquanto a
-- tela mostrava TEDE TRANSPORTES e 19/19,5 kg.
--
-- As validacoes sao as mesmas de f.fn_solicitacao_nfe_salvar_transporte, que ja fazia
-- certo no caminho da OV — os dois passam a gravar a mesma coisa do mesmo jeito.
--
-- Gerada a partir de pg_get_functiondef da funcao em producao; o unico que muda e o
-- bloco de transporte.
