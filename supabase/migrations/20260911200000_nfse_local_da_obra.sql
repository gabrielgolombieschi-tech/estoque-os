-- Local da obra na NFS-e de obra, e a aliquota de Guaramirim confirmada pelo ambiente nacional.
--
-- 1. OBRA. A primeira NFS-e em homologacao da OS 139 (WEG Tintas, pedido 4518572701) voltou
--    rejeitada pelo ambiente nacional: "E0370: O grupo de informacoes de obra e obrigatorio quando o
--    codigo de tributacao nacional pertencer a um dos subitens 07.02.01, 07.02.02, 07.04.01, 07.05.01,
--    07.05.02, 07.06.01, 07.06.02, 07.07.01, 07.08.01, 07.17.01, 07.19.01, 14.14.03 e 14.14.04". O
--    ERP nunca montou esse grupo.
--
--    As NFS-e reais de obra da WEG Tintas no padrao nacional (as de 29/07 e 03/08 e a 47, de 04/09/2026)
--    identificam a obra pelo endereco da fabrica de Guaramirim — que e o endereco do tomador. Mas a obra
--    pode estar em outro lugar, e o montador nao deduz nada; entao o local passa a ser campo da
--    conferencia: a tela sugere o endereco do tomador, deixa trocar ou informar o CNO (que tem
--    prioridade), e a conferencia grava em f.solicitacao_faturamento.obra_dados e no snapshot do servico.
--    Sem ele, nos codigos da lista, a conferencia bloqueia antes de gastar numero de DPS.
--
-- 2. GUARAMIRIM. A linha de 2% do 07.02 entrou na 20260911190000 pelo historico. A nota 47 (padrao
--    nacional, 04/09/2026) traz <pAliqAplic>2.00</pAliqAplic> para Guaramirim: e a aliquota que o
--    proprio ambiente nacional parametriza para o municipio. A fonte da linha passa a citar isso.

alter table f.solicitacao_faturamento
  add column if not exists obra_dados jsonb;

comment on column f.solicitacao_faturamento.obra_dados is
  'Local da obra da NFS-e (grupo obra da DPS), gravado pela conferencia: {codigo_obra} (CNO) ou {cep, logradouro, numero, complemento, bairro}. Obrigatorio nos codigos de tributacao de obra (E0370).';

update f.nfse_aliquota_iss
   set fonte = 'Ambiente nacional: a NFS-e 47 (padrao nacional, 04/09/2026, WEG Tintas, 07.02) traz pAliqAplic 2,00 para Guaramirim. Historico: 11 NFS-e 07.02 com material para a WEG Tintas em Guaramirim, dez/2025 a jun/2026, todas com ISS de 2% retido pelo tomador (1843, do pedido 4518572701). Lei municipal nao conferida; confirmar com o contador antes de liberar a producao.'
