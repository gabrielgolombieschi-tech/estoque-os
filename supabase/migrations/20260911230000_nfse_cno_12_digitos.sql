-- CNO da obra com 12 digitos.
--
-- Simulando pela tela um CNO digitado errado ("123"), o ambiente nacional de homologacao autorizou a
-- NFS-e (13, OS 139, 11/09/2026, abandonada em seguida). Nada no caminho avisava a pessoa. O Cadastro
-- Nacional de Obras tem 12 digitos (00.000.00000/00): a conferencia passa a recusar outro formato e
-- grava so os digitos.
