-- Claim de producao (f.fn_nfe_producao_preparar_e_claimar): definicao completa, identica a que esta
-- no online em 18/09/2026, no lugar dos dois patches por ancora (20260918030000 e 040000, removidos
-- do repositorio e da historia de migrations). E o que o Gabriel pediu: uma migration com CREATE OR
-- REPLACE da funcao inteira, para o banco local aplicado do zero ficar igual ao online.
--
-- O que ela traz alem da definicao de 20260917230000: na NF-e de entrada de importacao o vNF leva
-- o II (conferido contra operacao_snapshot.valor_total_ii) e o vItem de cada item leva o II e o
-- vOutro do item (ICMS por dentro), alem do IPI.
