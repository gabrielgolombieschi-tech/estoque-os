-- =====================================================================
-- SOLUÇÃO DEFINITIVA: EMPRESA ELÉTRICA SEGAU COMO PADRÃO PARA TODOS
-- =====================================================================
-- Esta migration garante que:
-- 1. A empresa "Elétrica Segau" existe
-- 2. TODOS os usuários são vinculados a ela automaticamente
-- 3. Ela é definida como empresa padrão no contexto de todos
-- =====================================================================
