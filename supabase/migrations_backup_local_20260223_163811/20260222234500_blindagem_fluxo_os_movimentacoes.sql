-- Blindagem de rastreabilidade das movimentacoes ligadas a OS.
-- 1) Sempre incluir referencia de OS no motivo quando houver origem_os_id
-- 2) Em baixa de OS, garantir origem_os_id preenchido e motivo normalizado
